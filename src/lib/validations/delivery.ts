...
export const DELIVERY_TYPES = ["freight", "last_mile"] as const;

export const PACKAGE_TYPES = ["pallet", "box", "crate", "envelope", "other"] as const;

export const loadSchema = z.object({
  deliveryType: z.enum(DELIVERY_TYPES),
  /** Granular last-mile service (courier/medical/grocery/etc) — only relevant when deliveryType is 'last_mile'. */
...
export type DeliveryFormValues = z.infer<typeof loadSchema>;
