          ...
          >
            <div className="max-w-xl">
              ...
              <p className="mb-4 text-lg text-white/80">
                Get a tailored quote for FTL, dedicated trucking, or RUSH
                delivery solutions built around your operational needs.
              </p>

              <p className="mb-12 text-lg font-medium text-white">
                Fast response. Transparent pricing. Reliable execution.
              </p>
              ...
              <form className="mt-8 space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <Input
                    ...
                    className="border-white/10 bg-white text-black rounded-xs"
                  />
                  <Input
                ...
                <Textarea
                  ...
                  className="min-h-30 border-white/10 bg-white text-black rounded-xs"
                />
                <Button
                  size="lg"
