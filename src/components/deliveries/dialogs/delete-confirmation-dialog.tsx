    ...
    <Dialog open={open} onOpenChange={handleClose}>
      ...
      >
        <DialogHeader className="border-b border-card-border px-7 py-5">
          <DialogTitle className="text-xl font-semibold text-foreground">Delete Delivery</DialogTitle>
        ...
        <div className="px-7 py-6 space-y-4">
          <div className="flex gap-3 rounded-[10px] border border-danger/20 bg-danger/5 px-4 py-4">
            ...
            <div>
              <p className="text-sm font-semibold text-danger">
                Delete <span className="font-bold">{delivery.load_number}</span>?
              </p>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Why is this delivery being deleted?"
