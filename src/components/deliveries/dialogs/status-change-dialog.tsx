...
import { StatusCombobox } from "@/components/deliveries/status-combobox";
import { Delivery, DELIVERY_STATUS_LABELS } from "@/types/api.types";
...
export function StatusChangeDialog({ delivery, open, onClose, onConfirm, loading }: Props) {
      ...
      >
        <DialogHeader className="border-b border-card-border px-7 py-5">
          ...
          <DialogDescription className="mt-1 text-sm text-muted">
            Delivery {delivery.load_number} — current status:{" "}
