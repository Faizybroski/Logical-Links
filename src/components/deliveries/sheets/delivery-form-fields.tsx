...
export function DeliveryLocationFields({ form }: { form: UseFormReturn<DeliveryFormValues> }) {
...
export function DeliveryScheduleFields({ form }: { form: UseFormReturn<DeliveryFormValues> }) {
  return (
    <FormSection
      title="Schedule"
...
export function DeliveryCargoFields({
  form,
